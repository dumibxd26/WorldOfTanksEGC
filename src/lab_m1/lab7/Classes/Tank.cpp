...
Tank::Tank(glm::vec3 bottom_position, float color_intensity, float rotation_angle, TankComponent* head, TankComponent* cannon, TankComponent* tracks, TankComponent* base) {
